...
class Password_change_ph extends Component {
  state = {
    username: '',
    password: '',
  ...
  handleSubmit = (event) => {
    ...
    axios
      .post('http://localhost:3001/policyholder_password_change', {username:this.state.username,password:this.state.password})
      .then((response) => {
...
export default Password_change_ph;